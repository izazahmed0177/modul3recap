...
<div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
	...
	<form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6">
		...
		<div className="space-y-1 text-sm">
			<label htmlFor="password"
             className="block text-gray-400">Password</label>
		...
		<div className="space-y-1 text-sm">
			<label htmlFor="password" 
            className="block text-gray-400">Confirm Password</label>
			<input type="password" required
        ...
        className="block w-full p-3 text-center rounded-sm
         text-gray-900 bg-violet-400">Register</button>
	...
	<p className="text-xs text-center sm:px-6 text-gray-400">Already have an account?
		<a rel="noopener noreferrer" href="/login" className="underline text-gray-100">Login</a>
	</p>
